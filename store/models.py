...
class Category(models.Model):
    ...
    slug = models.SlugField(unique=True) # finance-advice

    def __str__(self):
        return self.title

    # add extra information about the model
    class Meta:
...
class OrderItem(models.Model):
    ...
    order_status = models.CharField(max_length=100, choices=ORDER_STATUS, default="Pending")
    shippping_service = models.CharField(max_length=100, choices=SHIPPING_SERVICE, default=None, null=True, blank=True)
    ...
    vendor = models.ForeignKey(user_models.User, on_delete=models.SET_NULL, null=True, related_name="vendor_order_items", blank=True)
    date = models.DateTimeField(default=timezone.now)
...
class Review(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.SET_NULL, blank=True, null=True, related_name="re")
