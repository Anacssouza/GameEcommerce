# Generated by Django 4.2 on 2024-12-14 01:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0002_alter_gallery_options_rename_product_variant_product_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vendor notification+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('PayPal', 'PayPal'), ('Brazilian Bank Account', 'Brazilian Bank Account'), ('Indian Bank Account', 'Indian Bank Account'), ('USA Bank Account', 'USA Bank Account')], max_length=50, null=True)),
